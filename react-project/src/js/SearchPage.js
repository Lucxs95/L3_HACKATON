...
//Get the string of label for each SearchResult item and display only the label who correspond to the button click
    ...
    return (
        <div className='searchPage'>
            <div className='searchPage__info'>
                ...
                <h1>Stays nearby</h1>
                <Button variant="outlined">Wheelchair</Button>
                <Button variant="outlined">Blind</Button>
                <Button variant="outlined">Deaf</Button>
                <Button variant="outlined">Mental disability</Button>
            </div>
            <SearchResult
            ...
            <SearchResult
                ...
                description="4 guest · 4 bedroom · 4 bed · 2 bathrooms · Free parking · Adapted for deaf people"
                star={3.8}
                price="35€ / night"
                total="207€ total"
            />
